...
namespace Cryptograthy
{
    ...
    {
        //Опасность того, что детерминант матрицы ключа будет иметь общие делители с основанием модуля,
        //    может быть устранена путём выбора простого числа в качестве основания модуля.
        //длина алфавита - 127 - простое число 
        ...
        public void HillDecrypt()
        {
            string EncryptText = textBox2.Text;
            ...
            textBox2.Text = Decryption(EncryptText, Key_Matrix);
        }

        public void HillEncrypt()
        {
            ...
            textBox2.Text = Encryption(OpenText, Key_Matrix);
        }
